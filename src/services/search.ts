...
import { ExaResult, CryptoToken, ScrapedContent } from "../types";
import { batchProcessWithRateLimit } from "../utils/batch-processor";
import { UniversalScraper } from "./scraper";

/**
 * Search for content using Exa API
 */
export async function searchWithExa(queries: string[]): Promise<{ urls: string[], results: ExaResult[] }> {
